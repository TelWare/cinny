...
function isThread(mEvent) {
  console.log("isthread add to timeline function")
  return mEvent.getRelation()?.rel_type === "m.thread"
}
...
class RoomTimeline extends EventEmitter {
  ...
  addToTimeline(mEvent) {
    console.log(mEvent.getType(), "event type")
    ...
    if (isThread(mEvent)) {
      console.log("isthread add to timeline")
      addToMap(this.editedTimeline, mEvent)
      return
    }
  ...
  _populateAllLinkedEvents(timeline) {
    console.log(timeline, "populated timeline")
  ...
  _listenEvents() {
    this._listenRoomTimeline = (
      ...
      console.log(event, room, "listening to room timeline")
