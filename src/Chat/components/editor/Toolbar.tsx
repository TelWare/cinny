...
export function HeadingBlockButton({ className }) {
  const editor = useSlate()
        ...
        >
          <Menu style={{ padding: config.space.S100 }}>
            <Box gap="100">
              <TooltipProvider
                tooltip={
                  <BtnTooltip text="Heading 1" shortCode={`${modKey} + 1`} />
                }
                delay={500}
              >
                {(triggerRef) => (
              ...
              <TooltipProvider
                tooltip={
                  <BtnTooltip text="Heading 2" shortCode={`${modKey} + 2`} />
                }
                delay={500}
              >
                {(triggerRef) => (
              ...
              <TooltipProvider
                tooltip={
                  <BtnTooltip text="Heading 3" shortCode={`${modKey} + 3`} />
                }
                delay={500}
              >
                {(triggerRef) => (
...
type ExitFormattingProps = { tooltip: ReactNode; className: string }
export function ExitFormatting({ tooltip, className }: ExitFormattingProps) {
  const editor = useSlate()
...
export function Toolbar() {
  ...
  const canEscape =
    isAnyMarkActive(editor) || !isBlockActive(editor, BlockType.Paragraph)
        ...
        <Box className={css.EditorToolbar} alignItems="Center" gap="300">
          <>
            <Box shrink="No" gap="100">
              ...
              <MarkButton
                ...
                icon={Icons.Italic}
                tooltip={
                  <BtnTooltip text="Italic" shortCode={`${modKey} + I`} />
                }
              />
              <MarkButton
                ...
                tooltip={
                  <BtnTooltip text="Underline" shortCode={`${modKey} + U`} />
                }
              />
              <MarkButton
              ...
              <MarkButton
                ...
                icon={Icons.Code}
                tooltip={
                  <BtnTooltip text="Inline Code" shortCode={`${modKey} + [`} />
                }
              />
              <MarkButton
                ...
                icon={Icons.EyeBlind}
                tooltip={
                  <BtnTooltip text="Spoiler" shortCode={`${modKey} + H`} />
                }
              />
            </Box>
            <Line
          ...
          <Box shrink="No" gap="100">
            <BlockButton
              ...
              tooltip={
                <BtnTooltip text="Block Quote" shortCode={`${modKey} + '`} />
              }
            />
            <BlockButton
              className="iconButtonColor"
              ...
              tooltip={
                <BtnTooltip text="Block Code" shortCode={`${modKey} + ;`} />
              }
            />
            <BlockButton
              className="iconButtonColor"
              ...
              tooltip={
                <BtnTooltip text="Ordered List" shortCode={`${modKey} + 7`} />
              }
            />
            <BlockButton
              className="iconButtonColor"
              ...
              tooltip={
                <BtnTooltip text="Unordered List" shortCode={`${modKey} + 8`} />
              }
            />
            <HeadingBlockButton className="iconButtonColor" />
          </Box>
          {canEscape && (
            <>
              <Line
