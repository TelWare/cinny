    ...
    <div className="img-upload__wrapper">
      ...
      >
        <Avatar
          ...
          size={size}
        />
        <div className={`${isEditable ?'img-upload__process':''} ${uploadPromise === null  ? ' img-upload__process--stopped' : ''}`}>
          {uploadPromise === null && isEditable &&(
            size === 'large'
      ...
      {isEditable&& <input onChange={uploadImage} style={{ display: 'none' }} ref={uploadImageRef} type="file" accept="image/*" />}
    </div>
  );
}
