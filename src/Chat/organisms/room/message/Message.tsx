...
import MessageReadReceiptItemButton from "./SeenProfile"
import MessageReadReceiptItemIcon from "./SeenProfile"
        ...
        <OverlayCenter>
          ...
          >
            <Dialog variant="Surface">
              ...
              >
                <Text priority="400">
                  This action is irreversible! Are you sure that you want to
                  delete this message?
                </Text>
        ...
        <OverlayCenter>
          ...
          >
            <Dialog variant="Surface">
              ...
              >
                <Text priority="400">
                  Report this message to server, which may then notify the
...
export const Message = as<"div", MessageProps>(
  (
    ...
    const roomType =
      initMatrix.roomList.directs.has(room.roomId) ||
      initMatrix.roomList.favouritesDM.has(room.roomId)
        ? "DirectMessage"
        : "Channels"
    ...
    const headerJSX =
      (room?.getType() !== "Channels" && senderId !== currentUserID) ||
...
|
    ...
    const avatarJSX = ((room?.getType() !== "Channels" &&
      ...
      messageLayout !== 1 && (
        <AvatarBase>
          ...
          >
            {senderAvatarMxc ? (
              <AvatarAtom
                imageSrc={senderAvatarMxc}
                text={senderDisplayName[0]}
      ...
      >
        {messageLayout === 1 && (
          <CompactLayout before={headerJSX} onContextMenu={handleContextMenu}>
            {msgContentJSX}
            {/* <MessageReadReceiptItemIcon room={room} eventId={eventId} /> */}
          </CompactLayout>
        )}
        {messageLayout === 2 && (
          <BubbleLayout
            className={roomType === "Channels" ? "fullWidth" : ""}
            before={avatarJSX}
