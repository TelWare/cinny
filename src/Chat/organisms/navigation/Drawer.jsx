...
function Drawer() {
  const { selectedTab } = useContext(ChatWrapperContext)
        ...
        <div className="rooms__wrapper">
          <ScrollView ref={scrollRef} autoHide>
            <div className="rooms-container">
              {/* {selectedTab !== cons.tabs.PIN ? ( */}
              {selectedTab !== cons.tabs.HOME ? (
                <Directs size={roomList.directs.size} />
              ) : (
                <Home spaceId={spaceId} size={roomList.rooms.size} />
              )}
              {/* ) : (
                <Pinned size={roomList.favourites.size} />
              )} */}
            </div>
          </ScrollView>
        </div>
