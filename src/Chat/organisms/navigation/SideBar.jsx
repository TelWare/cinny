...
function FeaturedTab() {
  ...
  const favsNotiDM = getFavsNotiDM() || {};
  const favsNotiChannel = getFavsNotiChannel() || {}
  ...
  return (
    <>
      <SidebarAvatar
        ...
        notificationBadge={homeNoti ? (
          <NotificationBadge
            ...
            content={abbreviateNumber(homeNoti?.total + (favsNotiChannel?.total ?? 0)) || null}
          />
        ) : null}
      />
      <SidebarAvatar
        ...
        notificationBadge={dmsNoti ? (
          <NotificationBadge
            ...
            content={abbreviateNumber(dmsNoti?.total +( favsNotiDM?.total ?? 0)) || null}
          />
        ) : null}
      />
      ...
      {/* <SidebarAvatar
        tooltip="Pin spaces"
        active={selectedTab === cons.tabs.PIN}
        onClick={() => selectTab(cons.tabs.PIN)}
        avatar={<Avatar iconSrc={AddPinIC} size="normal" />}
        notificationBadge={
          favsNoti ? (
            <NotificationBadge
              alert={favsNoti?.highlight > 0}
              content={abbreviateNumber(favsNoti.total) || null}
            />
          ) : null
        }
      /> */}
