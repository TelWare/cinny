...
function DrawerHeader({ selectedTab, spaceId }) {
  ...
  const isHomeTab = selectedTab === cons.tabs.HOME;
  const room = mx.getRoom(spaceId);
  ...
  return (
    <Header>
      ...
      {isDMTab && <IconButton onClick={() => openInviteUser()} tooltip="Create a Direct Message" src={PlusIC} size="small" />}
      {isHomeTab && <IconButton onClick={openHomeSpaceOptions} tooltip="Create a Channel" src={PlusIC} size="small" />}
    </Header>
  );
}
